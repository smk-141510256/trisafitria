            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group<?php echo e($errors->has('nip') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="id_jabatan" type="text" class="form-control" name="id_jabatan" value="<?php echo e(old('id_jabatan')); ?>" required autofocus>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select class="form-control col-md-5 col-xs-12" name="id_golongan">
                                    ...
                                    <option value="<?php echo e($data->id); ?>"><?php echo e($data->id_golongan); ?></option>
